...
<!--For XLA one can run the samples via this [notebook](https://colab.research.google.com/drive/1I1MvDG4ikiGIg8DJH1ZWBbvlL43ttH8z?usp=sharing) in order to reproduce the experiments on TPUs.-->
...
Mention authors, examples, related projects
-->
